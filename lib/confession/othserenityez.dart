...
class Othserenityez extends StatefulWidget {
  ...
  @override
  State<Othserenityez> createState() => _Othserenityez();
}

class _Othserenityez extends State<Othserenityez> {
  final TextEditingController _isolatione = TextEditingController();
  final TextEditingController _emptinessm = TextEditingController();
  final TextEditingController _comfortingm = TextEditingController();
  @override
  void initState() {
    super.initState();
  }
