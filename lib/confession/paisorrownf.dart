...
class Paisorrownf extends StatefulWidget {
  const Paisorrownf({super.key});

  @override
  State<Paisorrownf> createState() => _Paisorrownf();
}

class _Paisorrownf extends State<Paisorrownf> {
  final TextEditingController _yearninge = TextEditingController();
  final TextEditingController _innerlightm = TextEditingController();
  final TextEditingController _afespacem = TextEditingController();
  @override
  void initState() {
    super.initState();
  }
